      ...
      <section className="py-8 -mt-16 relative z-40">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
            ...
            {/* Active Filters */}
            {(searchTerm || selectedType !== 'all' || selectedLocation !== 'all') && <div className="flex flex-wrap gap-2 mt-6 pt-4 border-t border-gray-100">
                ...
                {selectedType !== 'all' && <Badge variant="secondary" className="flex items-center gap-1">
                    {selectedType}
                      ...
                      <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center mb-3">
                            {[...Array(5)].map((_, i) => <Star key={i} className={`w-4 h-4 ${i < Math.floor(attraction.rating) ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'}`} />)}

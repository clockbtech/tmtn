...
const ExperienceDetail = () => {
  ...
  const experience = {
    ...
    reviews: [{
      ...
      photos: ['https://images.unsplash.com/photo-1464822759844-d150baec0494?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80']
    }, {
      id: 6,
      name: 'James Park',
      rating: 4,
    ...
    gallery: ['https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1518495973542-4542c06a5843?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1486022830324-0541c3b6f36e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1464822759844-d150baec0494?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1433086966358-54859d0ed716?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'],
    relatedExperiences: [{
      id: 2,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
                  ...
                  duration: 0.6
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-6 gap-2">
                        {experience.gallery.map((image, index) => <button key={index} onClick={() => setSelectedImageIndex(index)} className={`relative h-20 rounded overflow-hidden ${selectedImageIndex === index ? 'ring-2 ring-nepal-orange' : ''}`}>
            ...
            duration: 0.6
              ...
              <div className="relative">
                {/* Navigation Arrows */}
                <Button variant="outline" size="icon" className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-md hover:bg-gray-50" onClick={prevRelatedExperience} disabled={relatedExperiencesIndex === 0}>
                  <ChevronLeft className="w-4 h-4" />
                </Button>
          ...
          <div className="lg:col-span-1 hidden lg:block">
            <div className={`transition-all duration-300 ${isBookingSticky ? 'fixed top-6 right-6 z-40 w-80' : 'sticky top-6'}`}>

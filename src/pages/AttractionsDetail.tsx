...
const AttractionsDetail = () => {
  ...
  const attraction = {
    ...
    highlights: [
      'Ancient Buddhist stupa dating back 2,000 years',
      'Panoramic views of Kathmandu Valley',
      'Famous Buddha eyes on the golden spire',
      'Sacred pilgrimage site for Buddhists',
      'Home to hundreds of holy monkeys',
      'UNESCO World Heritage Site component'
    ],
    bestSeasons: [
      { icon: '🌸', months: 'March - May', description: 'Clear skies and comfortable temperatures' },
      { icon: '🍂', months: 'October - December', description: 'Excellent visibility and mild weather' }
    ],
    gallery: [
    ...
    travelTips: {
      safety: [
        'Be cautious of monkeys - do not feed or provoke them',
        'Climb the stairs slowly and take breaks if needed',
        'Respect religious customs and dress modestly',
        'Keep belongings secure from curious monkeys'
      ],
      quickFacts: [
        'Height: 77m above valley',
        'Steps to climb: 365',
      ...
      proTips: [
        ...
        'Combine with nearby Durbar Square visit'
      ]
    }
  };
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setSelectedImageIndex((prev) => 
        prev === attraction.gallery.length - 1 ? 0 : prev + 1
      );
    }, 4000);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {attraction.bestSeasons.map((season, index) => (
            ...
            >
              ...
              <Carousel className="w-full">
                <CarouselContent className="-ml-4">
                  {attraction.linkedAttractions.map((linkedAttraction) => (
                    <CarouselItem key={linkedAttraction.id} className="pl-4 md:basis-1/2">
                      <Card className="group cursor-pointer hover:shadow-lg transition-shadow">
                        <div className="relative overflow-hidden">
                          <img
                            src={linkedAttraction.image}
                            alt={linkedAttraction.name}
            ...
            >
              ...
              <Carousel className="w-full">
                <CarouselContent className="-ml-4">
                  {attraction.linkedExperiences.map((experience) => (
            ...
            <div className="sticky top-6 space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {attraction.travelTips.safety.map((tip, index) => (
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {attraction.travelTips.quickFacts.map((fact, index) => (
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {attraction.travelTips.proTips.map((tip, index) => (
                    <div key={index} className="flex items-start">
          ...
          <div className="relative max-w-7xl max-h-full p-4">
            ...
            <button
              onClick={() => setSelectedImageIndex(
                selectedImageIndex === 0 ? attraction.gallery.length - 1 : selectedImageIndex - 1
              )}
            ...
            <button
              onClick={() => setSelectedImageIndex(
                selectedImageIndex === attraction.gallery.length - 1 ? 0 : selectedImageIndex + 1
              )}

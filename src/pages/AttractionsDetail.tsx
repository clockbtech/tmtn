      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
                  ...
                  <img
                    ...
                    className={`w-full h-20 object-cover rounded cursor-pointer transition-opacity ${
                      selectedImageIndex === index
                        ? 'opacity-100 ring-2 ring-nepal-primary'
            ...
            {/* Linked Attractions - Updated to match Attractions page design */}
            <motion.section initial={{
              opacity: 0,
              y: 30
            }} whileInView={{
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center">
          <div className="relative max-w-7xl max-h-full p-4">
            ...
            <button
              onClick={() => setSelectedImageIndex(selectedImageIndex === 0 ? attraction.gallery.length - 1 : selectedImageIndex - 1)}
            ...
            <button
              onClick={() => setSelectedImageIndex(selectedImageIndex === attraction.gallery.length - 1 ? 0 : selectedImageIndex + 1)}

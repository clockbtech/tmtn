...
const Newsletter = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-nepal-primary to-blue-700">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-tm-sans uppercase font-bold text-white mb-4">
                ...
                >
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full px-6 py-4 rounded-full text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-nepal-orange/30 transition-all duration-200"
                      required
                    />
                  </div>

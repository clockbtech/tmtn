    ...
    <div className={`${isReply ? 'ml-8 border-l-2 border-gray-200 pl-4' : ''} mb-6`}>
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          ...
          {!isReply && (
            <Button variant="ghost" size="sm" className="text-tmtn-blue hover:text-tmtn-blue/80">
              Reply
            </Button>
          )}
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={4}
                className="w-full mt-1 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-tmtn-blue focus:border-transparent"

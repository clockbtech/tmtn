  ...
  return (
    <section ref={sectionRef} className="py-20 bg-nepal-primary text-white" id="about">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bebas uppercase font-bold mb-4 tracking-[15px]">
            ...
            return (
              ...
              >
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 h-full hover:bg-white/20 transition-all duration-300">
                  ...
                  <h3 className="text-xl font-bebas uppercase font-semibold mb-4 tracking-[15px]">
                    {feature.title}
                  </h3>
        ...
        >
          {[
            ...
            >
              <div className="text-3xl lg:text-4xl font-bebas uppercase font-bold text-nepal-orange mb-2 tracking-[15px]">
                {stat.number}
              </div>

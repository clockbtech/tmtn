  ...
  return <section ref={sectionRef} className="py-20 bg-nepal-primary text-white" id="about">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        duration: 0.8
          ...
          <h2 className="text-4xl lg:text-4xl font-tm-sans uppercase font-extrabold mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          return <motion.div key={index} className="feature-card text-center group" whileHover={{
            y: -10
          }} transition={{
            duration: 0.3
          }}>
                ...
                rotate: 5
                  ...
                  <h3 className="text-xl font-tm-sans font-semibold mb-4">
                    {feature.title}
                  </h3>

...
export const AttractionForm = ({ attraction, onClose }: AttractionFormProps) => {
  const [formData, setFormData] = useState({
    ...
    seasons: attraction?.seasons || [{ icon: '', months: '', description: '' }],
    safetyNotes: attraction?.safetyNotes || [''],
    quickFacts: attraction?.quickFacts || [{ label: '', value: '' }],
    proTips: attraction?.proTips || [''],
  });
          ...
          <TabsContent value="basic" className="space-y-4 mt-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Historic, Architecture, Photography"
              />
            </div>
          ...
          <TabsContent value="highlights" className="space-y-4 mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Add the main attractions and features of this attraction</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="seasons" className="space-y-4 mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Define the optimal seasons for visiting this attraction</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          <TabsContent value="safety" className="space-y-4 mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Important safety information for visitors</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          <TabsContent value="facts" className="space-y-4 mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Key information about the attraction</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          <TabsContent value="tips" className="space-y-4 mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Expert advice and insider tips for visitors</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">

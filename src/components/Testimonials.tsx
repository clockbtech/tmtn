...
const Testimonials = () => {
  ...
  return <section className="py-20 bg-gray-50 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        duration: 0.8
          ...
          <h2 className="text-4xl lg:text-5xl font-bebas uppercase font-extrabold text-nepal-primary mb-4">
        ...
        <div ref={carouselRef} className="relative max-w-4xl mx-auto" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
              ...
              <div className="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <div className="flex items-center justify-center lg:justify-start gap-4">
                    ...
                    scale: 1.1
                  }} src={testimonials[currentIndex].image} alt={testimonials[currentIndex].name} className="w-12 h-12 rounded-full object-cover" />
                    <div>
          ...
          <div className="flex justify-center mt-8 space-x-2">
            ...
            scale: 0.9
          }} onClick={() => setCurrentIndex(index)} className={`w-3 h-3 rounded-full transition-all duration-300 ${index === currentIndex ? 'bg-nepal-orange scale-125' : 'bg-gray-300'}`} />)}
          </div>
        </div>
      </div>
    </section>;

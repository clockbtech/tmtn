      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          scale: 1.05
            ...
            <Link to="/">
              <h1 className="text-2xl lg:text-3xl font-poppins lowercase text-nepal-primary">
                tmtn.
              </h1>
            </Link>
          </motion.div>
          ...
          <div className="hidden lg:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              scale: isSearchFocused ? 1.05 : 1
                ...
                <input type="text" placeholder={t('search.placeholder')} className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-nepal-orange focus:border-transparent" onFocus={() => setIsSearchFocused(true)} onBlur={() => setIsSearchFocused(false)} />
              </motion.div>
            </div>
          </div>

    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          >
            <h1 className="text-2xl lg:text-3xl font-playfair font-bold text-nepal-primary">
              Take Me To Nepal
            </h1>
          </motion.div>
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            {navItems.map((item) => (
              <motion.a
                ...
                href={item.href}
                whileHover={{ y: -2 }}
                className="text-gray-700 hover:text-nepal-primary font-medium transition-colors duration-200"
              >
                {item.name}
              </motion.a>
            ))}
            <motion.div
              ...
              className="ml-4"
            >
              <User className="w-6 h-6 text-gray-700 hover:text-nepal-primary cursor-pointer" />
            </motion.div>
          </nav>
              ...
              <div className="px-4 py-6 space-y-4">
                ...
                {navItems.map((item) => (
                  <motion.a
                    ...
                    href={item.href}
                    whileHover={{ x: 5 }}
                    className="block text-gray-700 hover:text-nepal-primary font-medium py-2"
